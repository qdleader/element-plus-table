...
export interface ProTableProps {
  ...
  tableSearchColumns?: ColumnProps[]; // 搜索列配置项  ==> 非必传
  useTableSearchColumns?: boolean; // 搜索列配置项  ==> 非必传
...
const tableSearchColumns = ref<ColumnProps[]>(props.tableSearchColumns);
